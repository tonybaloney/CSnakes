...
public class ParameterListParserTests
{
    ...
    [Theory]
    [InlineData("/", "Syntax error (line 1, column 2): unexpected `/`, expected `)` or `, )`.")]
    [InlineData("*", "Syntax error (line 1, column 3): unexpected `)`, expected Parameter or `,`.")]
    [InlineData("*, /", "Syntax error (line 1, column 3): unexpected `, /`, expected Parameter or `,`.")]
    [InlineData("/, *", "Syntax error (line 1, column 2): unexpected `/`, expected `)` or `, )`.")]
    [InlineData("a, /, /", "Syntax error (line 1, column 6): unexpected `, /`, expected `)` or `, )`.")]
    ...
    [InlineData("a, *, b, **c, **d", "Syntax error (line 1, column 14): unexpected `, **`, expected `)` or `, )`.")]
    [InlineData("a, /, *, b, **c, **d", "Syntax error (line 1, column 17): unexpected `, **`, expected `)` or `, )`.")]
    [InlineData("*args = 0", "Syntax error (line 1, column 8): unexpected `=`, expected `)` or `, )`.")]
    [InlineData("a, *args = 0", "Syntax error (line 1, column 11): unexpected `=`, expected `)` or `, )`.")]
    [InlineData("**kwargs = 0", "Syntax error (line 1, column 11): unexpected `=`, expected `)` or `, )`.")]
    [InlineData("a, **kwargs = 0", "Syntax error (line 1, column 14): unexpected `=`, expected `)` or `, )`.")]
