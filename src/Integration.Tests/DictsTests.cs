...
public class TestDicts(PythonEnvironmentFixture fixture) : IntegrationTestBase(fixture)
{
    ...
    public void TestDicts_TestDictStrListInt()
    {
        ...
        IReadOnlyDictionary<string, IReadOnlyList<long>> testListDict = new Dictionary<string, IReadOnlyList<long>> { { "hello", new List<long> { 1, 2, 3 } }, { "world2", new List<long> { 4, 5, 6 } } };
