...
public static class PyBufferExtensions
{
    ...
    #region AsSpan2D
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<bool>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<bool> AsBoolSpan2D(this IPyBuffer buffer) => buffer.AsSpan2D<bool>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<byte>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<byte> AsByteSpan2D(this IPyBuffer buffer) => buffer.AsSpan2D<byte>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<sbyte>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<sbyte> AsSByteSpan2D(this IPyBuffer buffer) => buffer.AsSpan2D<sbyte>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<short>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<short> AsInt16Span2D(this IPyBuffer buffer) => buffer.AsSpan2D<short>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<ushort>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<ushort> AsUInt16Span2D(this IPyBuffer buffer) => buffer.AsSpan2D<ushort>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<int>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<int> AsInt32Span2D(this IPyBuffer buffer) => buffer.AsSpan2D<int>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<uint>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<uint> AsUInt32Span2D(this IPyBuffer buffer) => buffer.AsSpan2D<uint>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<long>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<long> AsInt64Span2D(this IPyBuffer buffer) => buffer.AsSpan2D<long>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<ulong>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<ulong> AsUInt64Span2D(this IPyBuffer buffer) => buffer.AsSpan2D<ulong>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<Half>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<Half> AsHalfSpan2D(this IPyBuffer buffer) => buffer.AsSpan2D<Half>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<float>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<float> AsFloatSpan2D(this IPyBuffer buffer) => buffer.AsSpan2D<float>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<double>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<double> AsDoubleSpan2D(this IPyBuffer buffer) => buffer.AsSpan2D<double>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<nint>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<nint> AsIntPtrSpan2D(this IPyBuffer buffer) => buffer.AsSpan2D<nint>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<nuint>' and use its '{nameof(PyArray2DBuffer<>.Do)}' method instead.")]
    public static Span2D<nuint> AsUIntPtrSpan2D(this IPyBuffer buffer) => buffer.AsSpan2D<nuint>();
    #endregion

    #region AsReadOnlySpan2D
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<bool>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<bool> AsBoolReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<bool>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<byte>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<byte> AsByteReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<byte>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<sbyte>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<sbyte> AsSByteReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<sbyte>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<short>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<short> AsInt16ReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<short>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<ushort>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<ushort> AsUInt16ReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<ushort>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<int>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<int> AsInt32ReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<int>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<uint>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<uint> AsUInt32ReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<uint>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<long>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<long> AsInt64ReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<long>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<ulong>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<ulong> AsUInt64ReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<ulong>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<Half>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<Half> AsHalfReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<Half>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<float>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<float> AsFloatReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<float>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<double>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<double> AsDoubleReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<double>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<nint>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
    public static ReadOnlySpan2D<nint> AsIntPtrReadOnlySpan2D(this IPyBuffer buffer) => buffer.AsReadOnlySpan2D<nint>();
    [Obsolete($"Cast to '{nameof(PyArray2DBuffer<>)}<nuint>' and use its '{nameof(PyArray2DBuffer<>.Map)}' method instead.")]
