...
internal static class ResultConversionCodeGenerator
{
    ...
    private static readonly IResultConversionCodeGenerator Time = ScalarConversionGenerator(ParseTypeName("TimeOnly"), "Time");
    ...
    public static IResultConversionCodeGenerator Create(PythonTypeSpec pythonTypeSpec)
    {
        switch (pythonTypeSpec)
        {
            ...
            case TimeType: return Time;

            case OptionalType { Of: var t and (IntType or FloatType or BoolType or TupleType or TimeType) }:
            {
