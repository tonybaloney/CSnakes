...
public class ArgumentReflection
{
                                                              ...
                                                              PythonFunctionParameterType parameterType)
    {
        ...
        foreach ((TypeSyntax Type, LiteralExpressionSyntax LiteralExpression) syntax in
                 (parameterType, parameter) switch
                 {
                     ...
                     (PythonFunctionParameterType.Normal, { ImpliedTypeSpec: var type, DefaultValue: null }) =>
                         ...
                         select (t, (LiteralExpressionSyntax?)null),
        ...
        {
            var literalExpressionSyntax = syntax.LiteralExpression;
            // Create a new variable to avoid modifying the foreach iteration variable
            var adjustedReflectedType = syntax.Type;
