...
public class TypeReflectionTests
{
    ...
    [InlineData("list[int]", "IList<long>")]
    [InlineData("list[str]", "IList<string>")]
    [InlineData("list[float]", "IList<double>")]
    [InlineData("list[bool]", "IList<bool>")]
    [InlineData("list[object]", "IList<PyObject>")]
    ...
    [InlineData("tuple[str, list[int]]", "(string,IList<long>)")]
